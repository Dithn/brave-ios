...
extension Strings {
    ...
    public static let OBJoinButton = NSLocalizedString("OBJoinButton", bundle: Bundle.braveShared, value: "Start browsing", comment: "Button to join Brave Rewards.")
    ...
    public static let OBRewardsDetail = NSLocalizedString("OBRewardsDetail", bundle: Bundle.braveShared, value: "Earn tokens for seeing privacy-respecting ads. Use them to support our favorite sites and creators.", comment: "Detail text for rewards onboarding screen")
